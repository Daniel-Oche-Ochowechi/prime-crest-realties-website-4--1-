...
import { deleteProperty, deleteProperties, updatePropertiesStatus } from "@/actions/properties"
...
export default function AdminPropertiesClient({ initialProperties }: PropertiesClientProps) {
    ...
    const handleBulkStatusUpdate = async (newStatus: "available" | "sold") => {
        ...
        try {
            await updatePropertiesStatus(selectedProperties, newStatus)
            toast({
                title: "Success",
